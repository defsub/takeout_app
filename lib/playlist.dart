...
//   }
//
//   static Future playTrack(BuildContext context, MediaLocatable track) {
//     return playSpiff(context, fromTracks([track]), index: 0);
//   }
//
//   static Future playTracks(BuildContext context, List<MediaLocatable> tracks, {int index = 0}) {
//     return playSpiff(context, fromTracks(tracks), index: index);
//   }
//
//   static Future playSpiff(BuildContext context, Spiff spiff, {int index = 0}) async {
...
//   static Future play(BuildContext context, {Release? release, Series? series, Episode? episode, int index = 0}) async {
//     return _playRef(context, _ref(release: release, series: series, episode: episode), index: index);
//   }
//
...
//   ///
//   static Future _playRef(BuildContext context, Reference ref,
...
//         SpiffCache.put(spiff).then((_) {
//           final cubit = context.read<HistoryCubit>();
//           cubit.add(spiff: Spiff.cleanup(spiff));
//           audioHandler.customAction('doit', <String, dynamic>{
//             'spiff': uri.toString()
//           }).then((_) => completer.complete());
//         });
